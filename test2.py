...
report = classification_report(y_test_combined, y_test_pred, target_names=folder_label_map.keys())
...
sns.heatmap(conf_matrix, annot=True, fmt='d', cmap='Blues', xticklabels=folder_label_map.keys(), yticklabels=folder_label_map.keys())
